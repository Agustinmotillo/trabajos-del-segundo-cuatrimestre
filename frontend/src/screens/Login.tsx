...
export default function Login() {
  const { login } = useAuth() as any;   // deja tu contexto igual
  ...
  const googleLogin = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      try {
        ...
        // tokenResponse.access_token -> se la mandamos a tu backend
        ...
        // Guardamos la sesión igual que el login normal
  ...
  return (
    <View style={styles.screen}>
      <View style={styles.card}>
        ...
        <Text style={styles.subtitle}>Entrá con tu cuenta para continuar</Text>
